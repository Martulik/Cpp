...
void lysenko::Contacts::replaceNote(iterator curr, Note newNote)
{
  *curr = newNote;
}

lysenko::Contacts::constIterator lysenko::Contacts::showCurrNote(constIterator curr) const
{
  constIterator note = curr;
  return note;
}
