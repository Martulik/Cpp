...
{
  BOOST_CHECK_THROW(lab::Rectangle rect1(lab::point1, lab::negParam, lab::height), std::invalid_argument);
  BOOST_CHECK_THROW(lab::Rectangle rect2(lab::point2.x, lab::point2.y, lab::width, lab::negParam), std::invalid_argument);
}
