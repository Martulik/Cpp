...
{
  std::vector<lysenko::Shape> inp = { {{1,1},  {1,2},  {2,1},  {2,2}},
                                   {{4,5},  {5,-4},  {6,6},  {7,8},  {9,10},  {2,7}},
                                   {{9,8},  {3,9},  {3,1},  {3,1},  {3, 7},  {3, 5},  {8, 1}},
                                   {{1,1},  {1,2},  {4,1},  {4,2}},
                                   {{3,6},  {5,3},  {1,0}} };
  std::vector< lysenko::Shape > vect = std::accumulate(inp.begin(), inp.end(), std::vector<lysenko::Shape>(), lysenko::fillVect());
  lysenko::shapeSort(vect);

  std::vector<lysenko::Shape> sorted = { { {3,6},  {5,3},  {1,0}},
                                      {{1,1},  {1,2},  {2,1},  {2,2}},
                                      {{1,1},  {1,2},  {4,1},  {4,2}},
                                      {{4,5},  {5,-4},  {6,6},  {7,8},  {9,10},  {2,7}},
                                      {{9,8},  {3,9},  {3,1},  {3,1},  {3, 7},  {3, 5},  {8, 1}} };
