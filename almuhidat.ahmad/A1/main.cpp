...
int main()
{
  ...
  std::cout << "Described rectangle of a given circle:\n" << "Height: "
        << circle->getFrameRect().height << std::endl << "Width: "
        << circle->getFrameRect().width <<  std::endl <<"Abscissa of the center: "
        << circle->getFrameRect().pos.x << std::endl << "Ordinate of the center: "
    ...
    std::cout << "Described rectangle of a circle with a new center: " << std::endl << "Height: "
        << circle->getFrameRect().height << std::endl << "Width: "
        << circle->getFrameRect().width << std::endl << "Abscissa of the center: "
        << circle->getFrameRect().pos.x << std::endl << "Ordinate of the center: "
        << circle->getFrameRect().pos.y
    ...
    std::cout << "Described rectangle of a given rectangle: " << std::endl << "Height: "
        << rectangle->getFrameRect().height << std::endl << "Width: "
        << rectangle->getFrameRect().width << std::endl << "Abscissa of the center: "
        << rectangle->getFrameRect().pos.x << std::endl << "Ordinate of the center: "
